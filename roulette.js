    ...
    for (let i = 0; i < totalCoins; i++) {
        ...
        coin.innerHTML = `
            <div class="coin-content">
                <div class="coin-face">
                    <div class="skull"></div>
                    <div class="gold-drip drip-1"></div>
                    <div class="gold-drip drip-2"></div>
                    <div class="gold-drip drip-3"></div>
                </div>
...
function spin() {
    ...
    const coinHeight = 160;
    const centerOffset = 320; // Center of visible area (600px height / 2 - 80px coin center)
